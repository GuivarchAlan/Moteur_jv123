...
exports.DeformationCompositorComponent = void 0;
var GraphicsAPI = require("../graphicsAPI");
var resources_1 = require("../resources");
var compositorComponent_1 = require("./compositorComponent");
var GL;
var DeformationCompositorComponent = /** @class */ (function (_super) {
    __extends(DeformationCompositorComponent, _super);
    function DeformationCompositorComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    // ## Méthode *onEnabled*
    // La méthode *onEnabled* est appelée quand l'objet passe de l'état
    // activé à désactivé.
    DeformationCompositorComponent.prototype.onEnabled = function () {
        this.start = +new Date();
    };
    // ## Méthode *setup*
    // Charge les shaders et les textures nécessaires au composant
    DeformationCompositorComponent.prototype.setup = function (descr) {
        GL = GraphicsAPI.context;
        var width = GraphicsAPI.canvas.width;
        var height = GraphicsAPI.canvas.height;
        this.speed = descr.speed;
        this.scale = descr.scale;
        this.start = +new Date();
        _super.prototype.setup.call(this, descr);
        var deformationImage = resources_1.Resources.load(descr.source);
        ...
        var intensityImage = resources_1.Resources.load(descr.intensity);
    ...
    DeformationCompositorComponent.prototype.compose = function (texture) {
        GL.bindFramebuffer(GL.FRAMEBUFFER, this.rttFrameBuffer);
        // tslint:disable-next-line:no-bitwise
        GL.clear(GL.COLOR_BUFFER_BIT | GL.DEPTH_BUFFER_BIT);
        ...
        var elapsed = ((+new Date()) - this.start) / 1000 * this.speed;
